/*
 * VLIB API definitions 2020-06-30 12:41:57
...
static inline void *vl_api_mdata_enable_disable_t_print (vl_api_mdata_enable_disable_t *a, void *handle)
{
    u8 *s = 0;
...
static inline void *vl_api_mdata_enable_disable_reply_t_print (vl_api_mdata_enable_disable_reply_t *a, void *handle)
{
    u8 *s = 0;
    u32 indent __attribute__((unused)) = 2;
    int i __attribute__((unused));
...
static inline void vl_api_mdata_enable_disable_t_endian (vl_api_mdata_enable_disable_t *a)
{
    int i __attribute__((unused));
...
static inline void vl_api_mdata_enable_disable_reply_t_endian (vl_api_mdata_enable_disable_reply_t *a)
{
    int i __attribute__((unused));
    a->_vl_msg_id = clib_net_to_host_u16(a->_vl_msg_id);
    a->context = clib_net_to_host_u32(a->context);
