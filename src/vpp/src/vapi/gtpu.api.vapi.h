#ifndef __included__src_vpp_build_root_build_vpp_debug_native_vpp_plugins_gtpu_gtpu_api_json
#define __included__src_vpp_build_root_build_vpp_debug_native_vpp_plugins_gtpu_gtpu_api_json
...
static void __attribute__((constructor)) __vapi_constructor_gtpu_tunnel_details()
{
  ...
  static const char name_with_crc[] = "gtpu_tunnel_details_68853c3d";
...
static void __attribute__((constructor)) __vapi_constructor_gtpu_tunnel_dump()
{
  ...
  static const char name_with_crc[] = "gtpu_tunnel_dump_529cb13f";
...
static void __attribute__((constructor)) __vapi_constructor_gtpu_add_del_tunnel_reply()
{
  ...
  static const char name_with_crc[] = "gtpu_add_del_tunnel_reply_fda5941f";
...
static void __attribute__((constructor)) __vapi_constructor_gtpu_add_del_tunnel()
{
  ...
  static const char name_with_crc[] = "gtpu_add_del_tunnel_7ce9952e";
...
static void __attribute__((constructor)) __vapi_constructor_sw_interface_set_gtpu_bypass()
{
  ...
  static const char name_with_crc[] = "sw_interface_set_gtpu_bypass_e74ca095";
