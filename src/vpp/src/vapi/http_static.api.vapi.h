#ifndef __included__src_vpp_build_root_build_vpp_debug_native_vpp_plugins_http_static_http_static_api_json
#define __included__src_vpp_build_root_build_vpp_debug_native_vpp_plugins_http_static_http_static_api_json
...
static void __attribute__((constructor)) __vapi_constructor_http_static_enable()
{
  ...
  static const char name_with_crc[] = "http_static_enable_075f8292";
