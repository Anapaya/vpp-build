...
template <> inline void vapi_swap_to_be<vapi_msg_map_param_set_reassembly_reply>(vapi_msg_map_param_set_reassembly_reply *msg)
{
  vapi_msg_map_param_set_reassembly_reply_hton(msg);
}

template <> inline void vapi_swap_to_host<vapi_msg_map_param_set_reassembly_reply>(vapi_msg_map_param_set_reassembly_reply *msg)
{
  vapi_msg_map_param_set_reassembly_reply_ntoh(msg);
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<vapi_msg_map_param_set_reassembly_reply>()
{
  return ::vapi_msg_id_map_param_set_reassembly_reply; 
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<Msg<vapi_msg_map_param_set_reassembly_reply>>()
{
  return ::vapi_msg_id_map_param_set_reassembly_reply; 
}

static void __attribute__((constructor)) __vapi_cpp_constructor_map_param_set_reassembly_reply()
{
  vapi::vapi_msg_set_msg_id<vapi_msg_map_param_set_reassembly_reply>(vapi_msg_id_map_param_set_reassembly_reply);
}

template class Msg<vapi_msg_map_param_set_reassembly_reply>;

using Map_param_set_reassembly_reply = Msg<vapi_msg_map_param_set_reassembly_reply>;
...
template <> inline void vapi_swap_to_be<vapi_msg_map_param_set_reassembly>(vapi_msg_map_param_set_reassembly *msg)
{
  vapi_msg_map_param_set_reassembly_hton(msg);
}

template <> inline void vapi_swap_to_host<vapi_msg_map_param_set_reassembly>(vapi_msg_map_param_set_reassembly *msg)
{
  vapi_msg_map_param_set_reassembly_ntoh(msg);
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<vapi_msg_map_param_set_reassembly>()
{
  return ::vapi_msg_id_map_param_set_reassembly; 
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<Msg<vapi_msg_map_param_set_reassembly>>()
{
  return ::vapi_msg_id_map_param_set_reassembly; 
}

static void __attribute__((constructor)) __vapi_cpp_constructor_map_param_set_reassembly()
{
  vapi::vapi_msg_set_msg_id<vapi_msg_map_param_set_reassembly>(vapi_msg_id_map_param_set_reassembly);
}

template <> inline vapi_msg_map_param_set_reassembly* vapi_alloc<vapi_msg_map_param_set_reassembly>(Connection &con)
{
  vapi_msg_map_param_set_reassembly* result = vapi_alloc_map_param_set_reassembly(con.vapi_ctx);
#if VAPI_CPP_DEBUG_LEAKS
  con.on_shm_data_alloc(result);
#endif
  return result;
...
template class Msg<vapi_msg_map_param_set_reassembly>;

template class Request<vapi_msg_map_param_set_reassembly, vapi_msg_map_param_set_reassembly_reply>;

using Map_param_set_reassembly = Request<vapi_msg_map_param_set_reassembly, vapi_msg_map_param_set_reassembly_reply>;
