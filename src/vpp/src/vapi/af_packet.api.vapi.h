#ifndef __included__src_vpp_build_root_build_vpp_debug_native_vpp_vnet_devices_af_packet_af_packet_api_json
#define __included__src_vpp_build_root_build_vpp_debug_native_vpp_vnet_devices_af_packet_af_packet_api_json
...
static void __attribute__((constructor)) __vapi_constructor_af_packet_details()
{
  ...
  static const char name_with_crc[] = "af_packet_details_057205fa";
...
static void __attribute__((constructor)) __vapi_constructor_af_packet_delete()
{
  ...
  static const char name_with_crc[] = "af_packet_delete_3efceda3";
...
static void __attribute__((constructor)) __vapi_constructor_af_packet_create_reply()
{
  ...
  static const char name_with_crc[] = "af_packet_create_reply_fda5941f";
...
static void __attribute__((constructor)) __vapi_constructor_af_packet_create()
{
  ...
  static const char name_with_crc[] = "af_packet_create_6d5d30d6";
...
static void __attribute__((constructor)) __vapi_constructor_af_packet_set_l4_cksum_offload()
{
  ...
  static const char name_with_crc[] = "af_packet_set_l4_cksum_offload_86538585";
