#ifndef __included__src_vpp_build_root_build_vpp_debug_native_vpp_vnet_syslog_syslog_api_json
#define __included__src_vpp_build_root_build_vpp_debug_native_vpp_vnet_syslog_syslog_api_json
...
static void __attribute__((constructor)) __vapi_constructor_syslog_set_sender()
{
  ...
  static const char name_with_crc[] = "syslog_set_sender_bb641285";
