...
template <> inline void vapi_swap_to_be<vapi_msg_nat44_session_cleanup>(vapi_msg_nat44_session_cleanup *msg)
{
  vapi_msg_nat44_session_cleanup_hton(msg);
}

template <> inline void vapi_swap_to_host<vapi_msg_nat44_session_cleanup>(vapi_msg_nat44_session_cleanup *msg)
{
  vapi_msg_nat44_session_cleanup_ntoh(msg);
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<vapi_msg_nat44_session_cleanup>()
{
  return ::vapi_msg_id_nat44_session_cleanup; 
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<Msg<vapi_msg_nat44_session_cleanup>>()
{
  return ::vapi_msg_id_nat44_session_cleanup; 
}

static void __attribute__((constructor)) __vapi_cpp_constructor_nat44_session_cleanup()
{
  vapi::vapi_msg_set_msg_id<vapi_msg_nat44_session_cleanup>(vapi_msg_id_nat44_session_cleanup);
}

template <> inline vapi_msg_nat44_session_cleanup* vapi_alloc<vapi_msg_nat44_session_cleanup>(Connection &con)
{
  vapi_msg_nat44_session_cleanup* result = vapi_alloc_nat44_session_cleanup(con.vapi_ctx);
#if VAPI_CPP_DEBUG_LEAKS
  con.on_shm_data_alloc(result);
#endif
  return result;
...
template class Msg<vapi_msg_nat44_session_cleanup>;

template class Request<vapi_msg_nat44_session_cleanup, vapi_msg_nat44_session_cleanup_reply>;

using Nat44_session_cleanup = Request<vapi_msg_nat44_session_cleanup, vapi_msg_nat44_session_cleanup_reply>;

template <> inline void vapi_swap_to_be<vapi_msg_nat44_session_cleanup_reply>(vapi_msg_nat44_session_cleanup_reply *msg)
{
  vapi_msg_nat44_session_cleanup_reply_hton(msg);
}

template <> inline void vapi_swap_to_host<vapi_msg_nat44_session_cleanup_reply>(vapi_msg_nat44_session_cleanup_reply *msg)
{
  vapi_msg_nat44_session_cleanup_reply_ntoh(msg);
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<vapi_msg_nat44_session_cleanup_reply>()
{
  return ::vapi_msg_id_nat44_session_cleanup_reply; 
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<Msg<vapi_msg_nat44_session_cleanup_reply>>()
{
  return ::vapi_msg_id_nat44_session_cleanup_reply; 
}

static void __attribute__((constructor)) __vapi_cpp_constructor_nat44_session_cleanup_reply()
{
  vapi::vapi_msg_set_msg_id<vapi_msg_nat44_session_cleanup_reply>(vapi_msg_id_nat44_session_cleanup_reply);
}

template class Msg<vapi_msg_nat44_session_cleanup_reply>;

using Nat44_session_cleanup_reply = Msg<vapi_msg_nat44_session_cleanup_reply>;
...
template <> inline void vapi_swap_to_be<vapi_msg_nat44_del_user>(vapi_msg_nat44_del_user *msg)
{
  vapi_msg_nat44_del_user_hton(msg);
}

template <> inline void vapi_swap_to_host<vapi_msg_nat44_del_user>(vapi_msg_nat44_del_user *msg)
{
  vapi_msg_nat44_del_user_ntoh(msg);
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<vapi_msg_nat44_del_user>()
{
  return ::vapi_msg_id_nat44_del_user; 
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<Msg<vapi_msg_nat44_del_user>>()
{
  return ::vapi_msg_id_nat44_del_user; 
}

static void __attribute__((constructor)) __vapi_cpp_constructor_nat44_del_user()
{
  vapi::vapi_msg_set_msg_id<vapi_msg_nat44_del_user>(vapi_msg_id_nat44_del_user);
}

template <> inline vapi_msg_nat44_del_user* vapi_alloc<vapi_msg_nat44_del_user>(Connection &con)
{
  vapi_msg_nat44_del_user* result = vapi_alloc_nat44_del_user(con.vapi_ctx);
#if VAPI_CPP_DEBUG_LEAKS
  con.on_shm_data_alloc(result);
#endif
  return result;
...
template class Msg<vapi_msg_nat44_del_user>;

template class Request<vapi_msg_nat44_del_user, vapi_msg_nat44_del_user_reply>;

using Nat44_del_user = Request<vapi_msg_nat44_del_user, vapi_msg_nat44_del_user_reply>;

template <> inline void vapi_swap_to_be<vapi_msg_nat44_del_user_reply>(vapi_msg_nat44_del_user_reply *msg)
{
  vapi_msg_nat44_del_user_reply_hton(msg);
}

template <> inline void vapi_swap_to_host<vapi_msg_nat44_del_user_reply>(vapi_msg_nat44_del_user_reply *msg)
{
  vapi_msg_nat44_del_user_reply_ntoh(msg);
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<vapi_msg_nat44_del_user_reply>()
{
  return ::vapi_msg_id_nat44_del_user_reply; 
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<Msg<vapi_msg_nat44_del_user_reply>>()
{
  return ::vapi_msg_id_nat44_del_user_reply; 
}

static void __attribute__((constructor)) __vapi_cpp_constructor_nat44_del_user_reply()
{
  vapi::vapi_msg_set_msg_id<vapi_msg_nat44_del_user_reply>(vapi_msg_id_nat44_del_user_reply);
}

template class Msg<vapi_msg_nat44_del_user_reply>;

using Nat44_del_user_reply = Msg<vapi_msg_nat44_del_user_reply>;
