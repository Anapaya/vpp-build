#ifndef __included__src_vpp_build_root_build_vpp_debug_native_vpp_plugins_ioam_lib_pot_pot_api_json
#define __included__src_vpp_build_root_build_vpp_debug_native_vpp_plugins_ioam_lib_pot_pot_api_json
...
{
  return sizeof(*msg)+ msg->payload.list_name_len * sizeof(msg->payload.list_name[0]);
}

static inline vapi_msg_pot_profile_activate* vapi_alloc_pot_profile_activate(struct vapi_ctx_s *ctx, size_t _list_name_array_size)
{
  vapi_msg_pot_profile_activate *msg = NULL;
  const size_t size = sizeof(vapi_msg_pot_profile_activate) + sizeof(msg->payload.list_name[0]) * _list_name_array_size;
  /* cast here required to play nicely with C++ world ... */
  ...
  msg->payload.list_name_len = _list_name_array_size;
...
static void __attribute__((constructor)) __vapi_constructor_pot_profile_activate()
{
  ...
  static const char name_with_crc[] = "pot_profile_activate_eeada566";
...
static inline vapi_msg_pot_profile_del* vapi_alloc_pot_profile_del(struct vapi_ctx_s *ctx, size_t _list_name_array_size)
{
  vapi_msg_pot_profile_del *msg = NULL;
  const size_t size = sizeof(vapi_msg_pot_profile_del) + sizeof(msg->payload.list_name[0]) * _list_name_array_size;
  /* cast here required to play nicely with C++ world ... */
...
static void __attribute__((constructor)) __vapi_constructor_pot_profile_del()
{
  ...
  static const char name_with_crc[] = "pot_profile_del_bb100832";
...
static inline vapi_msg_pot_profile_add* vapi_alloc_pot_profile_add(struct vapi_ctx_s *ctx, size_t _list_name_array_size)
{
  vapi_msg_pot_profile_add *msg = NULL;
  const size_t size = sizeof(vapi_msg_pot_profile_add) + sizeof(msg->payload.list_name[0]) * _list_name_array_size;
  /* cast here required to play nicely with C++ world ... */
...
static void __attribute__((constructor)) __vapi_constructor_pot_profile_add()
{
  ...
  static const char name_with_crc[] = "pot_profile_add_e8f1d058";
