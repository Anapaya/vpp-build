#ifndef __included__src_vpp_build_root_build_vpp_debug_native_vpp_vnet_feature_feature_api_json
#define __included__src_vpp_build_root_build_vpp_debug_native_vpp_vnet_feature_feature_api_json
...
static void __attribute__((constructor)) __vapi_constructor_feature_enable_disable()
{
  ...
  static const char name_with_crc[] = "feature_enable_disable_f525e210";
