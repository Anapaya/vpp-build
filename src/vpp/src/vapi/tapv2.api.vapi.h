#ifndef __included__src_vpp_build_root_build_vpp_debug_native_vpp_vnet_devices_tap_tapv2_api_json
#define __included__src_vpp_build_root_build_vpp_debug_native_vpp_vnet_devices_tap_tapv2_api_json
