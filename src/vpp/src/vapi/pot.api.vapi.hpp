...
template <> inline vapi_msg_pot_profile_add* vapi_alloc<vapi_msg_pot_profile_add>(Connection &con)
{
  vapi_msg_pot_profile_add* result = vapi_alloc_pot_profile_add(con.vapi_ctx);
...
template class Request<vapi_msg_pot_profile_add, vapi_msg_pot_profile_add_reply>;

using Pot_profile_add = Request<vapi_msg_pot_profile_add, vapi_msg_pot_profile_add_reply>;
...
template <> inline vapi_msg_pot_profile_activate* vapi_alloc<vapi_msg_pot_profile_activate>(Connection &con)
{
  vapi_msg_pot_profile_activate* result = vapi_alloc_pot_profile_activate(con.vapi_ctx);
#if VAPI_CPP_DEBUG_LEAKS
  con.on_shm_data_alloc(result);
#endif
  return result;
...
template class Request<vapi_msg_pot_profile_activate, vapi_msg_pot_profile_activate_reply>;

using Pot_profile_activate = Request<vapi_msg_pot_profile_activate, vapi_msg_pot_profile_activate_reply>;
...
template <> inline vapi_msg_pot_profile_del* vapi_alloc<vapi_msg_pot_profile_del>(Connection &con)
{
  vapi_msg_pot_profile_del* result = vapi_alloc_pot_profile_del(con.vapi_ctx);
#if VAPI_CPP_DEBUG_LEAKS
  con.on_shm_data_alloc(result);
#endif
  return result;
...
template class Request<vapi_msg_pot_profile_del, vapi_msg_pot_profile_del_reply>;

using Pot_profile_del = Request<vapi_msg_pot_profile_del, vapi_msg_pot_profile_del_reply>;
