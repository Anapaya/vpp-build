#ifndef __included__src_vpp_build_root_build_vpp_debug_native_vpp_vnet_devices_pipe_pipe_api_json
#define __included__src_vpp_build_root_build_vpp_debug_native_vpp_vnet_devices_pipe_pipe_api_json
...
static void __attribute__((constructor)) __vapi_constructor_pipe_delete()
{
  ...
  static const char name_with_crc[] = "pipe_delete_529cb13f";
...
static void __attribute__((constructor)) __vapi_constructor_pipe_details()
{
  ...
  static const char name_with_crc[] = "pipe_details_91286b09";
...
static void __attribute__((constructor)) __vapi_constructor_pipe_create_reply()
{
  ...
  static const char name_with_crc[] = "pipe_create_reply_9f0eef14";
...
static void __attribute__((constructor)) __vapi_constructor_pipe_create()
{
  ...
  static const char name_with_crc[] = "pipe_create_db413409";
