/*
 * VLIB API definitions 2020-06-13 06:01:46
 * Input file: gbp.api
...
_(VL_API_GBP_ROUTE_DOMAIN_ADD, gbp_route_domain_add, 1560adc7) \
...
_(VL_API_GBP_ROUTE_DOMAIN_DETAILS, gbp_route_domain_details, 53241099) \
_(VL_API_GBP_ENDPOINT_ADD, gbp_endpoint_add, f0efa120) \
...
_(VL_API_GBP_ENDPOINT_DETAILS, gbp_endpoint_details, e1ca5e65) \
...
_(VL_API_GBP_SUBNET_ADD_DEL, gbp_subnet_add_del, f42b9430) \
_(VL_API_GBP_SUBNET_ADD_DEL_REPLY, gbp_subnet_add_del_reply, e8d4e804) \
_(VL_API_GBP_SUBNET_DUMP, gbp_subnet_dump, 51077d14) \
_(VL_API_GBP_SUBNET_DETAILS, gbp_subnet_details, 871555dc) \
_(VL_API_GBP_CONTRACT_ADD_DEL, gbp_contract_add_del, 5b63d90a) \
...
/***** manual: vl_api_gbp_scope_t_print  *****/
...
/***** manual: vl_api_gbp_scope_t_endian  *****/
...
vl_api_version(gbp.api, 0xefc264aa)
