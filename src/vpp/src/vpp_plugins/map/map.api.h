/*
 * VLIB API definitions 2020-06-13 06:01:57
 * Input file: map.api
...
_(VL_API_MAP_PARAM_GET_REPLY, map_param_get_reply, d0937e6b) 
#endif
...
vl_api_version_tuple(map.api, 4, 1, 0)
...
vl_api_version(map.api, 0xb39195f7)
