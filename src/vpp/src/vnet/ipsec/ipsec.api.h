...
_(VL_API_IPSEC_SPD_ENTRY_ADD_DEL, ipsec_spd_entry_add_del, db217840) \
...
_(VL_API_IPSEC_SPD_DETAILS, ipsec_spd_details, 021e2c20) \
...
_(VL_API_IPSEC_TUNNEL_PROTECT_UPDATE, ipsec_tunnel_protect_update, eccbc177) \
_(VL_API_IPSEC_TUNNEL_PROTECT_UPDATE_REPLY, ipsec_tunnel_protect_update_reply, e8d4e804) \
_(VL_API_IPSEC_TUNNEL_PROTECT_DEL, ipsec_tunnel_protect_del, f9e6675e) \
...
_(VL_API_IPSEC_TUNNEL_PROTECT_DETAILS, ipsec_tunnel_protect_details, 7520eefe) \
...
_(VL_API_IPSEC_TUNNEL_IF_ADD_DEL, ipsec_tunnel_if_add_del, d5a98274) \
...
vl_api_version(ipsec.api, 0xdc202cb1)
