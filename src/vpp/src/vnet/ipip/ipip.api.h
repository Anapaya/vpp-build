/*
 * VLIB API definitions 2020-06-13 06:00:56
 * Input file: ipip.api
...
_(VL_API_IPIP_ADD_TUNNEL, ipip_add_tunnel, 77d80f18) \
...
_(VL_API_IPIP_TUNNEL_DETAILS, ipip_tunnel_details, 3e06a87c) 
#endif
...
vl_api_version(ipip.api, 0x5afabe19)
