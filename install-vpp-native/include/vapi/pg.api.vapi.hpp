...
template <> inline vapi_msg_pg_enable_disable* vapi_alloc<vapi_msg_pg_enable_disable, size_t>(Connection &con, size_t _stream_name_array_size)
{
  vapi_msg_pg_enable_disable* result = vapi_alloc_pg_enable_disable(con.vapi_ctx, _stream_name_array_size);
...
template <> inline vapi_msg_pg_capture* vapi_alloc<vapi_msg_pg_capture, size_t>(Connection &con, size_t _pcap_file_name_array_size)
{
  vapi_msg_pg_capture* result = vapi_alloc_pg_capture(con.vapi_ctx, _pcap_file_name_array_size);
#if VAPI_CPP_DEBUG_LEAKS
  con.on_shm_data_alloc(result);
#endif
  return result;
