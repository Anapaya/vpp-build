...
template <> inline void vapi_swap_to_be<vapi_msg_punt_reason_dump>(vapi_msg_punt_reason_dump *msg)
{
  vapi_msg_punt_reason_dump_hton(msg);
}

template <> inline void vapi_swap_to_host<vapi_msg_punt_reason_dump>(vapi_msg_punt_reason_dump *msg)
{
  vapi_msg_punt_reason_dump_ntoh(msg);
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<vapi_msg_punt_reason_dump>()
{
  return ::vapi_msg_id_punt_reason_dump; 
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<Msg<vapi_msg_punt_reason_dump>>()
{
  return ::vapi_msg_id_punt_reason_dump; 
}

static void __attribute__((constructor)) __vapi_cpp_constructor_punt_reason_dump()
{
  vapi::vapi_msg_set_msg_id<vapi_msg_punt_reason_dump>(vapi_msg_id_punt_reason_dump);
}

template <> inline vapi_msg_punt_reason_dump* vapi_alloc<vapi_msg_punt_reason_dump>(Connection &con)
{
  vapi_msg_punt_reason_dump* result = vapi_alloc_punt_reason_dump(con.vapi_ctx);
#if VAPI_CPP_DEBUG_LEAKS
  con.on_shm_data_alloc(result);
#endif
  return result;
...
template class Msg<vapi_msg_punt_reason_dump>;

template class Dump<vapi_msg_punt_reason_dump, vapi_msg_punt_reason_details>;

using Punt_reason_dump = Dump<vapi_msg_punt_reason_dump, vapi_msg_punt_reason_details>;
...
template <> inline void vapi_swap_to_be<vapi_msg_punt_reason_details>(vapi_msg_punt_reason_details *msg)
{
  vapi_msg_punt_reason_details_hton(msg);
}

template <> inline void vapi_swap_to_host<vapi_msg_punt_reason_details>(vapi_msg_punt_reason_details *msg)
{
  vapi_msg_punt_reason_details_ntoh(msg);
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<vapi_msg_punt_reason_details>()
{
  return ::vapi_msg_id_punt_reason_details; 
}

template <> inline vapi_msg_id_t vapi_get_msg_id_t<Msg<vapi_msg_punt_reason_details>>()
{
  return ::vapi_msg_id_punt_reason_details; 
}

static void __attribute__((constructor)) __vapi_cpp_constructor_punt_reason_details()
{
  vapi::vapi_msg_set_msg_id<vapi_msg_punt_reason_details>(vapi_msg_id_punt_reason_details);
}

template class Msg<vapi_msg_punt_reason_details>;

using Punt_reason_details = Msg<vapi_msg_punt_reason_details>;
}
#endif
