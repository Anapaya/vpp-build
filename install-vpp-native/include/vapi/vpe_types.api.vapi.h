#ifndef __included__src_vpp_build_root_build_vpp_native_vpp_vpp_api_vpe_types_api_json
#define __included__src_vpp_build_root_build_vpp_native_vpp_vpp_api_vpe_types_api_json
