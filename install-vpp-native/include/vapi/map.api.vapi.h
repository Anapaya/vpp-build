#ifndef __included__src_vpp_build_root_build_vpp_native_vpp_plugins_map_map_api_json
#define __included__src_vpp_build_root_build_vpp_native_vpp_plugins_map_map_api_json
...
extern vapi_msg_id_t vapi_msg_id_map_param_set_reassembly_reply;
extern vapi_msg_id_t vapi_msg_id_map_param_set_traffic_class;
extern vapi_msg_id_t vapi_msg_id_map_param_set_reassembly;
...
#define DEFINE_VAPI_MSG_IDS_MAP_API_JSON\
  ...
  vapi_msg_id_t vapi_msg_id_map_param_set_reassembly_reply;\
  vapi_msg_id_t vapi_msg_id_map_param_set_traffic_class;\
  vapi_msg_id_t vapi_msg_id_map_param_set_reassembly;
...
static void __attribute__((constructor)) __vapi_constructor_map_domain_details()
{
  ...
  static const char name_with_crc[] = "map_domain_details_c36cec17";
...
static void __attribute__((constructor)) __vapi_constructor_map_rule_details()
{
  ...
  static const char name_with_crc[] = "map_rule_details_4f932665";
...
static inline void vapi_msg_map_param_get_reply_payload_hton(vapi_payload_map_param_get_reply *payload)
{
  ...
  payload->ip6_lifetime_ms = htobe16(payload->ip6_lifetime_ms);
  payload->ip6_pool_size = htobe16(payload->ip6_pool_size);
  payload->ip6_buffers = htobe32(payload->ip6_buffers);
}
...
static inline void vapi_msg_map_param_get_reply_payload_ntoh(vapi_payload_map_param_get_reply *payload)
{
  ...
  payload->ip6_lifetime_ms = be16toh(payload->ip6_lifetime_ms);
  payload->ip6_pool_size = be16toh(payload->ip6_pool_size);
  payload->ip6_buffers = be32toh(payload->ip6_buffers);
}
...
static void __attribute__((constructor)) __vapi_constructor_map_param_get_reply()
{
  ...
  static const char name_with_crc[] = "map_param_get_reply_b40e9226";
...
static void __attribute__((constructor)) __vapi_constructor_map_param_set_icmp()
{
  ...
  static const char name_with_crc[] = "map_param_set_icmp_4c0a4fd2";
...
static void __attribute__((constructor)) __vapi_constructor_map_if_enable_disable()
{
  ...
  static const char name_with_crc[] = "map_if_enable_disable_61a30cd9";
...
static void __attribute__((constructor)) __vapi_constructor_map_add_del_rule()
{
  ...
  static const char name_with_crc[] = "map_add_del_rule_e6132040";
...
static void __attribute__((constructor)) __vapi_constructor_map_add_domain()
{
  ...
  static const char name_with_crc[] = "map_add_domain_18755ddb";
...
static void __attribute__((constructor)) __vapi_constructor_map_param_add_del_pre_resolve()
{
  ...
  static const char name_with_crc[] = "map_param_add_del_pre_resolve_ea9a9a4a";
...
#ifndef defined_vapi_msg_map_param_set_reassembly_reply
#define defined_vapi_msg_map_param_set_reassembly_reply
typedef struct __attribute__ ((__packed__)) {
  i32 retval; 
} vapi_payload_map_param_set_reassembly_reply;

typedef struct __attribute__ ((__packed__)) {
  vapi_type_msg_header1_t header;
  vapi_payload_map_param_set_reassembly_reply payload;
} vapi_msg_map_param_set_reassembly_reply;

static inline void vapi_msg_map_param_set_reassembly_reply_payload_hton(vapi_payload_map_param_set_reassembly_reply *payload)
{
  payload->retval = htobe32(payload->retval);
}

static inline void vapi_msg_map_param_set_reassembly_reply_payload_ntoh(vapi_payload_map_param_set_reassembly_reply *payload)
{
  payload->retval = be32toh(payload->retval);
}

static inline void vapi_msg_map_param_set_reassembly_reply_hton(vapi_msg_map_param_set_reassembly_reply *msg)
{
  VAPI_DBG("Swapping `vapi_msg_map_param_set_reassembly_reply'@%p to big endian", msg);
  vapi_type_msg_header1_t_hton(&msg->header);
  vapi_msg_map_param_set_reassembly_reply_payload_hton(&msg->payload);
}

static inline void vapi_msg_map_param_set_reassembly_reply_ntoh(vapi_msg_map_param_set_reassembly_reply *msg)
{
  VAPI_DBG("Swapping `vapi_msg_map_param_set_reassembly_reply'@%p to host byte order", msg);
  vapi_type_msg_header1_t_ntoh(&msg->header);
  vapi_msg_map_param_set_reassembly_reply_payload_ntoh(&msg->payload);
}

static inline uword vapi_calc_map_param_set_reassembly_reply_msg_size(vapi_msg_map_param_set_reassembly_reply *msg)
{
  return sizeof(*msg);
}

static void __attribute__((constructor)) __vapi_constructor_map_param_set_reassembly_reply()
{
  static const char name[] = "map_param_set_reassembly_reply";
  static const char name_with_crc[] = "map_param_set_reassembly_reply_e8d4e804";
  static vapi_message_desc_t __vapi_metadata_map_param_set_reassembly_reply = {
    name,
    sizeof(name) - 1,
    name_with_crc,
    sizeof(name_with_crc) - 1,
    true,
    offsetof(vapi_type_msg_header1_t, context),
    offsetof(vapi_msg_map_param_set_reassembly_reply, payload),
    sizeof(vapi_msg_map_param_set_reassembly_reply),
    (generic_swap_fn_t)vapi_msg_map_param_set_reassembly_reply_hton,
    (generic_swap_fn_t)vapi_msg_map_param_set_reassembly_reply_ntoh,
    VAPI_INVALID_MSG_ID,
  };

  vapi_msg_id_map_param_set_reassembly_reply = vapi_register_msg(&__vapi_metadata_map_param_set_reassembly_reply);
  VAPI_DBG("Assigned msg id %d to map_param_set_reassembly_reply", vapi_msg_id_map_param_set_reassembly_reply);
}

static inline void vapi_set_vapi_msg_map_param_set_reassembly_reply_event_cb (
  struct vapi_ctx_s *ctx, 
  vapi_error_e (*callback)(struct vapi_ctx_s *ctx, void *callback_ctx, vapi_payload_map_param_set_reassembly_reply *payload),
  void *callback_ctx)
{
  vapi_set_event_cb(ctx, vapi_msg_id_map_param_set_reassembly_reply, (vapi_event_cb)callback, callback_ctx);
};
#endif
...
static void __attribute__((constructor)) __vapi_constructor_map_param_set_traffic_class()
{
  ...
  static const char name_with_crc[] = "map_param_set_traffic_class_007ee563";
...
#ifndef defined_vapi_msg_map_param_set_reassembly
#define defined_vapi_msg_map_param_set_reassembly
typedef struct __attribute__ ((__packed__)) {
  bool is_ip6;
  u16 lifetime_ms;
  u16 pool_size;
  u32 buffers;
  f64 ht_ratio; 
} vapi_payload_map_param_set_reassembly;

typedef struct __attribute__ ((__packed__)) {
  vapi_type_msg_header2_t header;
  vapi_payload_map_param_set_reassembly payload;
} vapi_msg_map_param_set_reassembly;

static inline void vapi_msg_map_param_set_reassembly_payload_hton(vapi_payload_map_param_set_reassembly *payload)
{
  payload->lifetime_ms = htobe16(payload->lifetime_ms);
  payload->pool_size = htobe16(payload->pool_size);
  payload->buffers = htobe32(payload->buffers);
}

static inline void vapi_msg_map_param_set_reassembly_payload_ntoh(vapi_payload_map_param_set_reassembly *payload)
{
  payload->lifetime_ms = be16toh(payload->lifetime_ms);
  payload->pool_size = be16toh(payload->pool_size);
  payload->buffers = be32toh(payload->buffers);
}

static inline void vapi_msg_map_param_set_reassembly_hton(vapi_msg_map_param_set_reassembly *msg)
{
  VAPI_DBG("Swapping `vapi_msg_map_param_set_reassembly'@%p to big endian", msg);
  vapi_type_msg_header2_t_hton(&msg->header);
  vapi_msg_map_param_set_reassembly_payload_hton(&msg->payload);
}

static inline void vapi_msg_map_param_set_reassembly_ntoh(vapi_msg_map_param_set_reassembly *msg)
{
  VAPI_DBG("Swapping `vapi_msg_map_param_set_reassembly'@%p to host byte order", msg);
  vapi_type_msg_header2_t_ntoh(&msg->header);
  vapi_msg_map_param_set_reassembly_payload_ntoh(&msg->payload);
}

static inline uword vapi_calc_map_param_set_reassembly_msg_size(vapi_msg_map_param_set_reassembly *msg)
{
  return sizeof(*msg);
}

static inline vapi_msg_map_param_set_reassembly* vapi_alloc_map_param_set_reassembly(struct vapi_ctx_s *ctx)
{
  vapi_msg_map_param_set_reassembly *msg = NULL;
  const size_t size = sizeof(vapi_msg_map_param_set_reassembly);
  /* cast here required to play nicely with C++ world ... */
  msg = (vapi_msg_map_param_set_reassembly*)vapi_msg_alloc(ctx, size);
  if (!msg) {
    return NULL;
  }
  msg->header.client_index = vapi_get_client_index(ctx);
  msg->header.context = 0;
  msg->header._vl_msg_id = vapi_lookup_vl_msg_id(ctx, vapi_msg_id_map_param_set_reassembly);

  return msg;
}

static inline vapi_error_e vapi_map_param_set_reassembly(struct vapi_ctx_s *ctx,
  vapi_msg_map_param_set_reassembly *msg,
  vapi_error_e (*callback)(struct vapi_ctx_s *ctx,
                           void *callback_ctx,
                           vapi_error_e rv,
                           bool is_last,
                           vapi_payload_map_param_set_reassembly_reply *reply),
  void *callback_ctx)
{
  if (!msg || !callback) {
    return VAPI_EINVAL;
  ...
  u32 req_context = vapi_gen_req_context(ctx);
  msg->header.context = req_context;
  vapi_msg_map_param_set_reassembly_hton(msg);
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, false, (vapi_cb_t)callback, callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    ...
    vapi_msg_map_param_set_reassembly_ntoh(msg);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
  }
...
static void __attribute__((constructor)) __vapi_constructor_map_param_set_reassembly()
{
  static const char name[] = "map_param_set_reassembly";
  static const char name_with_crc[] = "map_param_set_reassembly_54172b10";
  static vapi_message_desc_t __vapi_metadata_map_param_set_reassembly = {
    name,
    sizeof(name) - 1,
    name_with_crc,
    sizeof(name_with_crc) - 1,
    true,
    offsetof(vapi_type_msg_header2_t, context),
    offsetof(vapi_msg_map_param_set_reassembly, payload),
    sizeof(vapi_msg_map_param_set_reassembly),
    (generic_swap_fn_t)vapi_msg_map_param_set_reassembly_hton,
    (generic_swap_fn_t)vapi_msg_map_param_set_reassembly_ntoh,
    VAPI_INVALID_MSG_ID,
  };

  vapi_msg_id_map_param_set_reassembly = vapi_register_msg(&__vapi_metadata_map_param_set_reassembly);
  VAPI_DBG("Assigned msg id %d to map_param_set_reassembly", vapi_msg_id_map_param_set_reassembly);
}
#endif
