...
_(VL_API_SYSLOG_SET_SENDER, syslog_set_sender, 80126be2) \
_(VL_API_SYSLOG_SET_SENDER_REPLY, syslog_set_sender_reply, e8d4e804) \
_(VL_API_SYSLOG_GET_SENDER, syslog_get_sender, 51077d14) \
_(VL_API_SYSLOG_GET_SENDER_REPLY, syslog_get_sender_reply, 47af60ff) \
...
vl_api_version(syslog.api, 0x99a6a2b4)
