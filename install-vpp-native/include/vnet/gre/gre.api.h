...
_(VL_API_GRE_TUNNEL_ADD_DEL, gre_tunnel_add_del, 04199f47) \
_(VL_API_GRE_TUNNEL_ADD_DEL_REPLY, gre_tunnel_add_del_reply, 903324db) \
_(VL_API_GRE_TUNNEL_DUMP, gre_tunnel_dump, d85aab0d) \
_(VL_API_GRE_TUNNEL_DETAILS, gre_tunnel_details, fd0e1d36) 
#endif

/****** Typedefs ******/

#ifdef vl_typedefs
#ifndef included_gre_api
#define included_gre_api
...
#ifndef _vl_api_defined_gre_tunnel_type
#define _vl_api_defined_gre_tunnel_type
typedef enum {
...
#ifndef _vl_api_defined_gre_tunnel
#define _vl_api_defined_gre_tunnel
typedef VL_API_PACKED(struct _vl_api_gre_tunnel {
    u32 client_index;
    u32 context;
    u16 session_id;
...
#ifndef _vl_api_defined_gre_tunnel_add_del
#define _vl_api_defined_gre_tunnel_add_del
typedef VL_API_PACKED(struct _vl_api_gre_tunnel_add_del {
    u16 _vl_msg_id;
    u32 client_index;
    u32 context;
    bool is_add;
...
#ifndef _vl_api_defined_gre_tunnel_add_del_reply
#define _vl_api_defined_gre_tunnel_add_del_reply
typedef VL_API_PACKED(struct _vl_api_gre_tunnel_add_del_reply {
    u16 _vl_msg_id;
    u32 context;
    i32 retval;
    vl_api_interface_index_t sw_if_index;
...
#ifndef _vl_api_defined_gre_tunnel_dump
#define _vl_api_defined_gre_tunnel_dump
typedef VL_API_PACKED(struct _vl_api_gre_tunnel_dump {
    u16 _vl_msg_id;
    u32 client_index;
    u32 context;
    vl_api_interface_index_t sw_if_index;
...
#ifndef _vl_api_defined_gre_tunnel_details
#define _vl_api_defined_gre_tunnel_details
typedef VL_API_PACKED(struct _vl_api_gre_tunnel_details {
    u16 _vl_msg_id;
    u32 context;
    vl_api_gre_tunnel_t tunnel;
...
#ifndef _vl_api_defined_gre_tunnel_t_print
#define _vl_api_defined_gre_tunnel_t_print
static inline void *vl_api_gre_tunnel_t_print (vl_api_gre_tunnel_t *a,void *handle)
{
    vl_print(handle, "vl_api_gre_tunnel_t:\n");
    vl_print(handle, "client_index: %u\n", a->client_index);
    vl_print(handle, "context: %u\n", a->context);
    vl_print(handle, "session_id: %u\n", a->session_id);
    vl_print(handle, "instance: %u\n", a->instance);
    vl_print(handle, "outer_fib_id: %u\n", a->outer_fib_id);
    return handle;
}

#endif

#ifndef _vl_api_defined_gre_tunnel_add_del_t_print
#define _vl_api_defined_gre_tunnel_add_del_t_print
static inline void *vl_api_gre_tunnel_add_del_t_print (vl_api_gre_tunnel_add_del_t *a,void *handle)
{
    vl_print(handle, "vl_api_gre_tunnel_add_del_t:\n");
...
#ifndef _vl_api_defined_gre_tunnel_add_del_reply_t_print
#define _vl_api_defined_gre_tunnel_add_del_reply_t_print
static inline void *vl_api_gre_tunnel_add_del_reply_t_print (vl_api_gre_tunnel_add_del_reply_t *a,void *handle)
{
    vl_print(handle, "vl_api_gre_tunnel_add_del_reply_t:\n");
    vl_print(handle, "_vl_msg_id: %u\n", a->_vl_msg_id);
    vl_print(handle, "context: %u\n", a->context);
...
#ifndef _vl_api_defined_gre_tunnel_dump_t_print
#define _vl_api_defined_gre_tunnel_dump_t_print
static inline void *vl_api_gre_tunnel_dump_t_print (vl_api_gre_tunnel_dump_t *a,void *handle)
{
    vl_print(handle, "vl_api_gre_tunnel_dump_t:\n");
    vl_print(handle, "_vl_msg_id: %u\n", a->_vl_msg_id);
    vl_print(handle, "client_index: %u\n", a->client_index);
    vl_print(handle, "context: %u\n", a->context);
    return handle;
...
#ifndef _vl_api_defined_gre_tunnel_details_t_print
#define _vl_api_defined_gre_tunnel_details_t_print
static inline void *vl_api_gre_tunnel_details_t_print (vl_api_gre_tunnel_details_t *a,void *handle)
{
    vl_print(handle, "vl_api_gre_tunnel_details_t:\n");
    vl_print(handle, "_vl_msg_id: %u\n", a->_vl_msg_id);
    vl_print(handle, "context: %u\n", a->context);
    return handle;
}
...
#ifndef _vl_api_defined_gre_tunnel_t_endian
#define _vl_api_defined_gre_tunnel_t_endian
static inline void vl_api_gre_tunnel_t_endian (vl_api_gre_tunnel_t *a)
{
    ...
    a->outer_fib_id = clib_net_to_host_u32(a->outer_fib_id);
...
#ifndef _vl_api_defined_gre_tunnel_add_del_t_endian
#define _vl_api_defined_gre_tunnel_add_del_t_endian
...
#ifndef _vl_api_defined_gre_tunnel_add_del_reply_t_endian
#define _vl_api_defined_gre_tunnel_add_del_reply_t_endian
...
#ifndef _vl_api_defined_gre_tunnel_dump_t_endian
#define _vl_api_defined_gre_tunnel_dump_t_endian
...
#ifndef _vl_api_defined_gre_tunnel_details_t_endian
#define _vl_api_defined_gre_tunnel_details_t_endian
...
vl_api_version_tuple(gre.api, 2, 0, 0)
...
vl_api_version(gre.api, 0xed1d2d72)
