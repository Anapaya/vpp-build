/*
 * VLIB API definitions 2020-01-07 14:21:37
 * Input file: lb.api
...
_(VL_API_LB_CONF, lb_conf, a48c4a98) \
_(VL_API_LB_CONF_REPLY, lb_conf_reply, e8d4e804) \
_(VL_API_LB_ADD_DEL_VIP, lb_add_del_vip, 27f0ce5f) \
_(VL_API_LB_ADD_DEL_VIP_REPLY, lb_add_del_vip_reply, e8d4e804) \
_(VL_API_LB_ADD_DEL_AS, lb_add_del_as, 9febc02f) \
_(VL_API_LB_ADD_DEL_AS_REPLY, lb_add_del_as_reply, e8d4e804) \
_(VL_API_LB_FLUSH_VIP, lb_flush_vip, 2c8349f6) \
_(VL_API_LB_FLUSH_VIP_REPLY, lb_flush_vip_reply, e8d4e804) \
_(VL_API_LB_VIP_DUMP, lb_vip_dump, 0553b44f) \
_(VL_API_LB_VIP_DETAILS, lb_vip_details, 4f6d684f) \
_(VL_API_LB_AS_DUMP, lb_as_dump, 2c8349f6) \
_(VL_API_LB_AS_DETAILS, lb_as_details, 36a59ef5) 
#endif
...
vl_api_version(lb.api, 0xe181aba0)
