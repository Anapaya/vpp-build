...
_(VL_API_CLI_INBAND, cli_inband, b1ad59b3) \
_(VL_API_CLI_REPLY, cli_reply, 06d68297) \
_(VL_API_CLI_INBAND_REPLY, cli_inband_reply, 6d3c80a4) \
...
_(VL_API_SHOW_VERSION_REPLY, show_version_reply, b9bcf6df) \
...
_(VL_API_LOG_DUMP, log_dump, e4a022b6) \
_(VL_API_LOG_DETAILS, log_details, 4aea1f4d) \
_(VL_API_SHOW_VPE_SYSTEM_TIME, show_vpe_system_time, 51077d14) \
_(VL_API_SHOW_VPE_SYSTEM_TIME_REPLY, show_vpe_system_time_reply, 3b12fb3f) \
...
vl_api_version_tuple(vpe.api, 1, 5, 0)
...
vl_api_version(vpe.api, 0x2521f24d)
