#ifndef __included__src_vpp_build_root_build_vpp_debug_native_vpp_vpp_api_vpe_api_json
#define __included__src_vpp_build_root_build_vpp_debug_native_vpp_vpp_api_vpe_api_json
...
static void __attribute__((constructor)) __vapi_constructor_cli_inband_reply()
{
  ...
  static const char name_with_crc[] = "cli_inband_reply_6d3c80a4";
...
static void __attribute__((constructor)) __vapi_constructor_cli_inband()
{
  ...
  static const char name_with_crc[] = "cli_inband_b1ad59b3";
...
static void __attribute__((constructor)) __vapi_constructor_show_vpe_system_time_reply()
{
  ...
  static const char name_with_crc[] = "show_vpe_system_time_reply_3b12fb3f";
...
typedef struct __attribute__ ((__packed__)) {
  i32 retval;
  vl_api_string_t program;
  vl_api_string_t version;
  vl_api_string_t build_date;
  vl_api_string_t build_directory; 
...
static void __attribute__((constructor)) __vapi_constructor_show_version_reply()
{
  ...
  static const char name_with_crc[] = "show_version_reply_b9bcf6df";
...
typedef struct __attribute__ ((__packed__)) {
  ...
  vl_api_string_t msg_class;
  vl_api_string_t message; 
...
static void __attribute__((constructor)) __vapi_constructor_log_details()
{
  ...
  static const char name_with_crc[] = "log_details_4aea1f4d";
...
static void __attribute__((constructor)) __vapi_constructor_log_dump()
{
  ...
  static const char name_with_crc[] = "log_dump_e4a022b6";
