#ifndef __included__src_vpp_build_root_build_vpp_debug_native_vpp_plugins_mactime_mactime_api_json
#define __included__src_vpp_build_root_build_vpp_debug_native_vpp_plugins_mactime_mactime_api_json
...
static void __attribute__((constructor)) __vapi_constructor_mactime_add_del_range()
{
  ...
  static const char name_with_crc[] = "mactime_add_del_range_eda8702f";
...
static void __attribute__((constructor)) __vapi_constructor_mactime_enable_disable()
{
  ...
  static const char name_with_crc[] = "mactime_enable_disable_57298519";
