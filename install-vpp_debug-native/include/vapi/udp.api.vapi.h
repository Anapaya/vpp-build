#ifndef __included__src_vpp_build_root_build_vpp_debug_native_vpp_vnet_udp_udp_api_json
#define __included__src_vpp_build_root_build_vpp_debug_native_vpp_vnet_udp_udp_api_json
...
static inline void vapi_type_udp_encap_hton(vapi_type_udp_encap *msg)
{
  ...
  vapi_type_address_hton(&msg->src_ip);
  vapi_type_address_hton(&msg->dst_ip);
...
static inline void vapi_type_udp_encap_ntoh(vapi_type_udp_encap *msg)
{
  ...
  vapi_type_address_ntoh(&msg->src_ip);
  vapi_type_address_ntoh(&msg->dst_ip);
...
static void __attribute__((constructor)) __vapi_constructor_udp_encap_add()
{
  ...
  static const char name_with_crc[] = "udp_encap_add_6d68f146";
...
static void __attribute__((constructor)) __vapi_constructor_udp_encap_details()
{
  ...
  static const char name_with_crc[] = "udp_encap_details_547c034b";
