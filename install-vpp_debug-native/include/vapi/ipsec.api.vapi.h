#ifndef __included__src_vpp_build_root_build_vpp_debug_native_vpp_vnet_ipsec_ipsec_api_json
#define __included__src_vpp_build_root_build_vpp_debug_native_vpp_vnet_ipsec_ipsec_api_json
...
static inline void vapi_type_ipsec_spd_entry_hton(vapi_type_ipsec_spd_entry *msg)
{
  ...
  vapi_type_address_hton(&msg->remote_address_start);
  vapi_type_address_hton(&msg->remote_address_stop);
  vapi_type_address_hton(&msg->local_address_start);
  vapi_type_address_hton(&msg->local_address_stop);
...
static inline void vapi_type_ipsec_spd_entry_ntoh(vapi_type_ipsec_spd_entry *msg)
{
  ...
  vapi_type_address_ntoh(&msg->remote_address_start);
  vapi_type_address_ntoh(&msg->remote_address_stop);
  vapi_type_address_ntoh(&msg->local_address_start);
  vapi_type_address_ntoh(&msg->local_address_stop);
...
static inline void vapi_type_ipsec_sad_entry_hton(vapi_type_ipsec_sad_entry *msg)
{
  ...
  vapi_type_address_hton(&msg->tunnel_src);
  vapi_type_address_hton(&msg->tunnel_dst);
...
static inline void vapi_type_ipsec_sad_entry_ntoh(vapi_type_ipsec_sad_entry *msg)
{
  ...
  vapi_type_address_ntoh(&msg->tunnel_src);
  vapi_type_address_ntoh(&msg->tunnel_dst);
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_backend_details()
{
  ...
  static const char name_with_crc[] = "ipsec_backend_details_7700751c";
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_spd_add_del()
{
  ...
  static const char name_with_crc[] = "ipsec_spd_add_del_9ffdf5da";
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_spd_interface_details()
{
  ...
  static const char name_with_crc[] = "ipsec_spd_interface_details_2c54296d";
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_interface_add_del_spd()
{
  ...
  static const char name_with_crc[] = "ipsec_interface_add_del_spd_1e3b8286";
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_tunnel_if_set_sa()
{
  ...
  static const char name_with_crc[] = "ipsec_tunnel_if_set_sa_6ab567f2";
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_spd_entry_add_del()
{
  ...
  static const char name_with_crc[] = "ipsec_spd_entry_add_del_6bc6a3b5";
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_tunnel_protect_details()
{
  ...
  static const char name_with_crc[] = "ipsec_tunnel_protect_details_f724bc50";
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_tunnel_protect_dump()
{
  ...
  static const char name_with_crc[] = "ipsec_tunnel_protect_dump_d85aab0d";
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_select_backend()
{
  ...
  static const char name_with_crc[] = "ipsec_select_backend_4fd24836";
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_tunnel_protect_del()
{
  ...
  static const char name_with_crc[] = "ipsec_tunnel_protect_del_d85aab0d";
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_tunnel_protect_update()
{
  ...
  static const char name_with_crc[] = "ipsec_tunnel_protect_update_316dab99";
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_tunnel_if_add_del_reply()
{
  ...
  static const char name_with_crc[] = "ipsec_tunnel_if_add_del_reply_fda5941f";
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_sad_entry_add_del()
{
  ...
  static const char name_with_crc[] = "ipsec_sad_entry_add_del_a25ab61e";
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_spd_details()
{
  ...
  static const char name_with_crc[] = "ipsec_spd_details_06df7fb3";
...
static inline void vapi_msg_ipsec_sa_details_payload_hton(vapi_payload_ipsec_sa_details *payload)
{
  ...
  payload->total_data_size = htobe64(payload->total_data_size);
}
...
static inline void vapi_msg_ipsec_sa_details_payload_ntoh(vapi_payload_ipsec_sa_details *payload)
{
  ...
  payload->total_data_size = be64toh(payload->total_data_size);
}
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_sa_details()
{
  ...
  static const char name_with_crc[] = "ipsec_sa_details_9c8d829a";
...
{
  vapi_type_address_hton(&payload->local_ip);
  vapi_type_address_hton(&payload->remote_ip);
...
{
  vapi_type_address_ntoh(&payload->local_ip);
  vapi_type_address_ntoh(&payload->remote_ip);
...
static void __attribute__((constructor)) __vapi_constructor_ipsec_tunnel_if_add_del()
{
  ...
  static const char name_with_crc[] = "ipsec_tunnel_if_add_del_aa539b47";
