...
_(VL_API_BIER_DISP_ENTRY_ADD_DEL, bier_disp_entry_add_del, 51dd9d5d) \
...
_(VL_API_BIER_DISP_ENTRY_DETAILS, bier_disp_entry_details, e5ea0c21) 
#endif
...
vl_api_version(bier.api, 0x2e6c2bed)
