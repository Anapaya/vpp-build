...
_(VL_API_SW_INTERFACE_IP6ND_RA_PREFIX, sw_interface_ip6nd_ra_prefix, 0f759f82) \
_(VL_API_SW_INTERFACE_IP6ND_RA_PREFIX_REPLY, sw_interface_ip6nd_ra_prefix_reply, e8d4e804) \
_(VL_API_IP6ND_PROXY_ADD_DEL, ip6nd_proxy_add_del, bff10d55) \
_(VL_API_IP6ND_PROXY_ADD_DEL_REPLY, ip6nd_proxy_add_del_reply, e8d4e804) \
_(VL_API_IP6ND_PROXY_DETAILS, ip6nd_proxy_details, bbbd7894) \
...
_(VL_API_IP_MROUTE_ADD_DEL, ip_mroute_add_del, 997baab2) \
_(VL_API_IP_MROUTE_ADD_DEL_REPLY, ip_mroute_add_del_reply, 1992deab) \
_(VL_API_IP_MROUTE_DUMP, ip_mroute_dump, f5ad78e8) \
_(VL_API_IP_MROUTE_DETAILS, ip_mroute_details, 39405e5a) \
_(VL_API_IP_ADDRESS_DETAILS, ip_address_details, 2f1dbc7d) \
...
_(VL_API_MFIB_SIGNAL_DETAILS, mfib_signal_details, cd461bfa) \
_(VL_API_IP_PUNT_POLICE, ip_punt_police, 38691592) \
_(VL_API_IP_PUNT_POLICE_REPLY, ip_punt_police_reply, e8d4e804) \
_(VL_API_IP_PUNT_REDIRECT, ip_punt_redirect, 70b793c6) \
...
_(VL_API_IP_PUNT_REDIRECT_DETAILS, ip_punt_redirect_details, 07e504f8) \
_(VL_API_IP_CONTAINER_PROXY_ADD_DEL, ip_container_proxy_add_del, 5ba831f3) \
...
_(VL_API_IP_CONTAINER_PROXY_DETAILS, ip_container_proxy_details, 2f1dbc7d) \
_(VL_API_IP_SOURCE_AND_PORT_RANGE_CHECK_ADD_DEL, ip_source_and_port_range_check_add_del, b50ed159) \
...
_(VL_API_IP_PROBE_NEIGHBOR, ip_probe_neighbor, 2736142d) \
_(VL_API_IP_PROBE_NEIGHBOR_REPLY, ip_probe_neighbor_reply, e8d4e804) \
_(VL_API_WANT_IP4_ARP_EVENTS, want_ip4_arp_events, 70fd7195) \
_(VL_API_WANT_IP4_ARP_EVENTS_REPLY, want_ip4_arp_events_reply, e8d4e804) \
_(VL_API_IP4_ARP_EVENT, ip4_arp_event, 72cdde7c) \
_(VL_API_WANT_IP6_ND_EVENTS, want_ip6_nd_events, ba330719) \
_(VL_API_WANT_IP6_ND_EVENTS_REPLY, want_ip6_nd_events_reply, e8d4e804) \
_(VL_API_IP6_ND_EVENT, ip6_nd_event, 3a23e7d4) \
...
_(VL_API_IP6_RA_EVENT, ip6_ra_event, 34c9ddac) \
_(VL_API_PROXY_ARP_ADD_DEL, proxy_arp_add_del, 93a0e853) \
_(VL_API_PROXY_ARP_ADD_DEL_REPLY, proxy_arp_add_del_reply, e8d4e804) \
_(VL_API_PROXY_ARP_DUMP, proxy_arp_dump, 51077d14) \
_(VL_API_PROXY_ARP_DETAILS, proxy_arp_details, 2515902a) \
...
vl_api_version(ip.api, 0x902699f5)
