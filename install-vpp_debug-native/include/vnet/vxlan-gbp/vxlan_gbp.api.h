...
_(VL_API_VXLAN_GBP_TUNNEL_ADD_DEL, vxlan_gbp_tunnel_add_del, 052b07d6) \
...
_(VL_API_VXLAN_GBP_TUNNEL_DETAILS, vxlan_gbp_tunnel_details, 48f879be) \
...
vl_api_version(vxlan_gbp.api, 0xbac46121)
